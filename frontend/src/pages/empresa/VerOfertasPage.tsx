                            ...
                            <nav className="relative z-0 inline-flex shadow-sm rounded-md">
                                ...
                                {Array.from({ length: Math.ceil(ofertas.length / ofertasPerPage) }, (_, index) => (
                                    <a
                                        ...
                                        className={`-ml-px relative inline-flex items-center px-4 py-2 border border-gray-300 bg-white text-sm font-medium ${currentPage === index + 1 ? 'bg-red-700 text-white' : 'text-gray-700 hover:bg-blue-500 hover:text-white'}`}
                                    >
                                        {index + 1}
                                    </a>
                                ))}
